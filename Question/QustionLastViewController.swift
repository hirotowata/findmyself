//
//  QustionLastViewController.swift
//  findmyself
//
...
class QuestinLastViewController: UIViewController {
    ...
    func setUpQuiz() {
        ...
        let quiz1 = Quiz( text: "これまでで一番モチベが高くて頑張った体験は？",  option2: "保存する" )
        let quiz2 = Quiz(text: "それはなんで頑張った？きっかけは？", option2: "保存する")
        let quiz3 = Quiz( text: "その状況に対してどう対処した？",  option2: "保存する")
        let quiz4 = Quiz( text: "今の自分と比べてどう？自分とはどんな人間？",  option2: "保存する")
        //
...
//    }
    @IBAction func save(){
        ...
        let object = NCMBObject(className:"Lmessage")
